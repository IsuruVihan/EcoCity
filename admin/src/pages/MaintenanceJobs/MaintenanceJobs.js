...
const MaintenanceJobs = () => {
  return (
      <Col lg={10} className='p-0 ' style={{border: '2px solid black'}}>
        <Row className='p-0 m-0 mt-4 ps-3' style={{border: '2px solid red', 
        fontSize: 35, 
        fontWeight: 900, 
        color:'#042434'}} >
          Maintenance Jobs
        ...
        <Row className='p-0 m-0' style={{border: '2px solid red'}}>
          <Row className='p-0 m-0' style={{border: '2px solid blue'}}>
            <Col sm={10} className='p-0 m-0' style={{border: '2px solid green'}}></Col>
