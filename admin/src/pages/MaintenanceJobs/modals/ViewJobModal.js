  ...
  return (
    <Container className={'m-0 p-0'}>
        ...
        <Row className={'m-0 p-3 overflow-auto'} style={{fontSize:13, height:300}}>
          <Row className={'m-0 p-0'}>
            <Col>
              <Row style={{width:250, paddingBottom:6}}>
                <Col style={{fontWeight:'bold'}} className={'m-0 p-0'}>
                  Job Status
                </Col>
                <Col>
                  <Row style={{width:78, paddingTop:5,paddingBottom:5,paddingRight:10,paddingLeft:10,borderRadius:5, backgroundColor:'#E1F0FF', color:'#008BD1', fontWeight:'bold',}}>
                    Assigned
                  </Row>
                </Col>
              </Row>
          ...
          <Row className={'m-0 p-0 pb-3'} 
          style={{ marginRight:15 , marginLeft:15 , fontWeight:'bold', paddingBottom:5}}>Location</Row>
          <Row className={'m-0 p-0'} 
          style={{border:'1px solid black', height:'300px', borderRadius:'10px'}}>
            <JobMap/>
          </Row>
        </Row>
    </Container>
