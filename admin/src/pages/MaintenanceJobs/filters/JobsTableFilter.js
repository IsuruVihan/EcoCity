...
const JobsTableFilter = () => {
  ...
  return (
    <Container>
      ...
      <Row style={{position: 'absolute', zIndex:'' ,right: 25, paddingTop: 8, width:'500px', zIndex:1}}>
        <Collapse in={open}>
          <Container  id="example-collapse-text">
            <Row >
              <Col style={{borderBottomRightRadius: 15, borderBottomLeftRadius: 15, boxShadow: `0px 4px 8px #707070`}}>
                <Row className="m-1">
                  <Col sm={8}>
                    <Row>
                ...
                <Row style={{
                  ...
                  <Col>
                    ...
                    <Row>
                      <Col className="p-0 m-0" sm={7} style={{display:'flex', textAlign:'center', alignItems:'center',justifyContent:'center'}}>
                        <Row className="p-0 m-0">
                          ...
                          <Col className="p-0 m-0">
                            <Row className="p-0 m-2">
                              <Col className="p-0 m-0" style={{display:'flex', textAlign:'center', alignItems:'center'}}>
                                <input type='checkbox'
                                      style={{cursor: 'pointer'}}/>
                                <label
                                  style={{fontSize: 11, marginLeft: 10}}>
                      ...
                      <Col className="p-0 m-0" sm={5}>
                        <Row className="p-0 m-0">
                          <Col style={{textAlign: 'left',paddingTop:'5px'}} sm={4}>
                            <Image src={from_date} width="70%"/>
                          </Col>
                          <Col style={{
                            textAlign: 'left',
                            fontSize: 12,
                ...
                <Row style={{marginLeft: .5,marginRight: .5,paddingBottom: 10, paddingTop:10}}>
                  <Col sm={9}></Col>
                  <Col className="p-0 m-0" sm={3} style={{padding:3}}>
