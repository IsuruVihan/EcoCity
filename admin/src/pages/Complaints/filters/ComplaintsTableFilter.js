...
const ComplaintsTableFilter = () => {
  return (
          ...
          <Row className=" " >
              <Col></Col>
              <Col style={{borderBottomRightRadius:15 , borderBottomLeftRadius:15, boxShadow: `0px 4px 8px #707070`,}} lg={5}>
                  <Row className="m-1">
                      <Col>
                          <Row>
                              <Col>
                                  <input type='checkbox' style={{cursor: 'pointer'}}/>
                                  <label style={{fontSize:11, marginLeft:5}}>
                                      All
                                  </label>
                              </Col>
                          </Row>
                  ...
                  <Row style={{borderTop:'2px solid #BFDDDE',
                      ...
                      <Col>
                          <Row>
                              ...
                              <Col xs={8} >
                                  <input style={{width:130 , border:'none' ,
                                          outline:'none',
                          ...
                          <Row>
                              ...
                              <Col xs={8} >
                                  <input
                                      style={{width:130 , border:'none' , outline:'none' , borderBottom:'2px solid #E9E8EF'}}/>
                              </Col>
                          </Row>
                          <Row className="mx-1 mt-3 ">
                              ...
                              <Col style={{textAlign:'left',
                                  ...
                                  From date
                                  <input type="date"
                                         style={{border:'none' , color:'#228693', outline:'none'}}/>
                              </Col>
                          ...
                          <Row className="mx-1 mt-3">
                              ...
                              <Col style={{textAlign:'left',
                                  ...
                                  To date
                                  <input type="date"
                                         style={{border:'none' , color:'#BFDDDE' , outline:'none'}}/>
                              </Col>

                          </Row>
                      </Col>
                  </Row>
                  <Row  className="me-2 mt-2 mb-1 p-1" style={{ marginLeft:'60%' ,}}>
                      <Col>
