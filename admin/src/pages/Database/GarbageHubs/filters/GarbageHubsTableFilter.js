            ...
            <form id='garbageHubTableFilter'>
                ...
                <Row className='mx-0 filters-section my-3'>
                    <div className='ms-2 w-auto' id={'binStatus'}>
                        ...
                        <FormCheck name={'binStatus'} id='active' label='Active' style={{color: '#00C186'}}/>
                        <FormCheck name={'binStatus'} id='underMaintenance' label='Under Maintenance'
                                   style={{color: '#FF9900'}}/>
                        <FormCheck name={'binStatus'} id='unavailable' label='Unavailable' style={{color: '#A3A3A3'}}/>
                        <FormCheck name={'binStatus'} id='removed' label='Removed' style={{color: '#E73838'}}/>
                    </div>
                </Row>
