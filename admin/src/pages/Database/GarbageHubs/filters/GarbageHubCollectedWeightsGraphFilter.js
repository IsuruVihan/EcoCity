...
const GarbageHubCollectedWeightsGraphFilter = () => {
    ...
    return (
        <div>
            ...
            <Row className="p-0" style={{position: "absolute", right: 45, paddingTop: 15}}>
                <Collapse in={open}>
                    <Container id="example-collapse-text" style={{
                        ...
                        <Row className='mx-0 mt-3 mb-1'>
                            <Col lg={12}>Garbage Type</Col>
                            <Col lg={12} className='px-0 ms-4 w-auto mt-2'>
                                <FormCheck type={'checkbox'} id={'Organic'} label={'Organic'}/>
                                <FormCheck type={'checkbox'} id={'Plastic'} label={'Plastic'}/>
                                <FormCheck type={'checkbox'} id={'Glass'} label={'Glass'}/>
                                <FormCheck type={'checkbox'} id={'Paper'} label={'Paper'}/>
...
export default GarbageHubCollectedWeightsGraphFilter;
