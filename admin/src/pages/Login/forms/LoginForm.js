            ...
            <Row className="mx-0 justify-content-center  px-0 ">
                  ...
                  <div className=' m-1 p-1  '>
                    ...
                    <div className='d-flex pb-1  ' style={{borderBottom: "2px solid #238692"}}>
                      ...
                      <div className="d-flex  mx-0  px-0  ">
                        ...
                        <button style={{border: 'none', outline: 'none', backgroundColor: '#fff'}}
                                onClick={showPassword}>
                          <div style={{width: 20, height: 30}}><Image src={eye} fluid/></div>
                        </button>
                      </div>
                    </div>
                  </div>
              ...
              <Row className="mx-0 justify-content-center p-2 px-0 ps-5 pe-5">
                <div style={{paddingLeft: 80, paddingRight: 80}}>
                  <Button variant="primary" type="submit" className="shadow " style={{
                    backgroundColor: '#238692',
                    fontSize: 20,
                    paddingTop: 10,
                    width: '100%',
        ...
        <Row className="mx-0 justify-content-center">
          <Col className="mx-0 pb-5  d-flex justify-content-center ">
            <div className="d-flex justify-content-space-evenly">
              <div className=' rounded-4 border border-2 ' style={{
