...
import GarbageImg from "../assets/images/mobile-garbage-collection.png";
...
import GarbageImgSelected from "../assets/images/mobile-garbage-collection2.png";
...
const Footer = ({selected, onChange}) => {
  return (
    <View style={styles.footer}>
      ...
      >
        <Image
          source={selected === 'complaint' ? GarbageImgSelected : GarbageImg}
