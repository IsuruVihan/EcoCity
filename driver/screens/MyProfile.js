...
import DriverImg from '../assets/images/driver-profile.png';
...
const MyProfile = () => {
  ...
  const [driverId, setDriverId] = useState('#1234');
    ...
    return (
      ...
      >
        ...
        <View style={styles.myProfile.profile.section}>
          ...
          {Item('Driver ID', setDriverId, driverId, false)}
    ...
    <View style={styles.myProfile}>
      ...
      <View style={styles.myProfile.status}>
        <View style={styles.myProfile.status.first}>
          <Image source={DriverImg} style={styles.myProfile.status.first.img}/>
        </View>
        <View style={styles.myProfile.status.second}>
          ...
          <Text style={styles.myProfile.status.second.txt2}>Driver ID: 1234</Text>
        </View>
