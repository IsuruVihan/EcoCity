    ...
    <View style={styles.areaMap}>
      ...
      <View style={styles.areaMap.sec2}>
        ...
        <View style={styles.areaMap.sec2.legend}>
          ...
          <Text style={styles.areaMap.sec2.legend.txt}>Repairing</Text>
        </View>
        <View style={styles.areaMap.sec2.legend}>
          <Image style={styles.areaMap.sec2.legend.img} source={UnavailableHub}/>
          <Text style={styles.areaMap.sec2.legend.txt}>Unavailable</Text>
        </View>
      </View>
